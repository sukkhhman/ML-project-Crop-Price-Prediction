...
st.title("Crop Price Prediction using machine learning ")
st.header('By lingayas institute of management and technology Students')
st.subheader("        - studen 1 -studen 2 - studen 3 - studen 4 -")
